...
public class ThreadEnhancerDemoController {
    ...
    public String case2() {
        ...
        Threads.execute("case2-timeout", runnable, Instant.now().plus(Duration.ofSeconds(4)), myExceptionCallBack);
        return "ok";
    }
    /**
    ...
    public String case3() {
        ...
        Threads.execute("case3-exception", runnable, Instant.now().plus(Duration.ofSeconds(2)), myExceptionCallBack);
        return "ok";
    }
