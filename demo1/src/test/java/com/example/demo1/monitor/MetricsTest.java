...
// 2.4 之后需要加这个 && @SpringBootTest(properties = {"management.endpoints.web.exposure.include=*"})
public class MetricsTest extends BaseWebTest {
    ...
    public void test0() throws Exception {
        String[] resultContains = {"# HELP demo1_thread_pool_threads",
                ...
                "demo1_thread_pool_threads{appId=\"demo1\",module=\"shoulderThreadPool\",name=\"active\",} 0.0",
                ...
                "demo1_thread_pool_threads{appId=\"demo1\",module=\"test\",name=\"largest\",} 0.0",
        ...
        for (String except : resultContains) {
            Assertions.assertTrue(content.contains(except), () -> "miss " + except);
        }
    }
